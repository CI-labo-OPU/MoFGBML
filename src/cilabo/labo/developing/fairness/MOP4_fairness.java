 ...
 *
 */
public class MOP4_fairness<S extends Solution<?>> extends AbstractPitssburghGBML_Problem<S> {
	// ************************************
	...
	// ************************************
	public MOP4_fairness(DataSet train) {
		this.evaluationDataset = train;
		setNumberOfVariables(train.getNdim()*Consts.MAX_RULE_NUM);	// 可変だが、最大値で設定
		setNumberOfObjectives(4);	// 4目的
		setNumberOfConstraints(0);
		setName("MOP4_maxGmean_and_minNrule_and_minFPRdiff_and_minPPVdiff");
