 ...
 *
 */
public class MOP3_fairness<S extends Solution<?>> extends AbstractPitssburghGBML_Problem<S> {
	// ************************************
	...
	// ************************************
	public MOP3_fairness(DataSet train) {
		...
		setName("MOP3_maxGmean_and_minNrule_and_minPPVdiff");
	...
	public void evaluate(IntegerSolution solution) {
		...
		/* The third objective */
		PositivePredictiveValuesDifference function3 = new PositivePredictiveValuesDifference();
